...
const BestSellerProducts = () => {
  ...
  return (<Container>
        ...
        <h1 className='w-full text-center text-[30px] text-[#1e2832] font-semibold mt-[80px] mb-[40px]'> Best Seller Products
    ...
    {categories.map((item)=>(
      ...
      onClick={()=>handleGetProduct(item._id)}
       ...
       className='text-[16px] mr-[40px] cursor-pointer text-[#000000]  hover:text-[#757575]' key={item._id}>
      {item.title}
      </p>
   ))}
  </Row>
